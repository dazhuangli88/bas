		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#ivyuicomputerrequestappivy-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ivyuicomputerrequestappivy-display": {
								"semanticObject": "ivyuicomputerrequestappivy",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ivy.uicomputerrequestappivy",
									"url": sap.ui.require.toUrl("ivy/uicomputerrequestappivy")
								}
							}
						}
					}
